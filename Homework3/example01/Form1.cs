...
namespace Example01
{
    public partial class Form1 : Form
    {
        ...
        private void addButton_Click(object sender, EventArgs e)
        {
            ...
            {
                employee = new Manager(idTextBox.Text, nameTextBox.Text, baseSalaryTextBox.Text, leaderTextBox.Text);
            }
        ...
        private void UpdateEmployeesInfo()
        {
            ...
            leaderTextBox.Text = string.Empty;
        ...
        private void employeeCatagory_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            leaderLabel.Visible = employeeCatagory.SelectedIndex == 2;
            leaderTextBox.Visible = employeeCatagory.SelectedIndex == 2;
